...
function VideoPlayer (){
    ...
    return (
            <form className="video-play" onSubmit={handleSubmit}>
                ...
                <div className='video-play__form-wrapper-main'>
                    <div className="video-play__wrapper-desktop-1">
                        <h3 className="video-play__label-thumb">VIDEO THUMBNAIL</h3>
                        <img className="video-play__holder" src={videoPreview} alt="" />
                    </div>
                    <div className="video-play__wrapper-desktop-2">
                ...
                <div className='video-play__btn-wrapper'>
                    <button className="video-play__publish-btn" src={arrow}>PUBLISH
                    </button>
